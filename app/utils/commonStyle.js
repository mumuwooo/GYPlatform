...
global.DEVICE_TYPE =
  deviceWidth < 360 ? 'min' : deviceWidth > 450 ? 'big' : 'default'
...
let commonStyle = {
  ...
  /** height * */
  // 导航栏的高度
  navHeight: Platform.OS === 'ios' ? (deviceInfo.isIphoneX ? 88 : 64) : 45,
  // 导航栏顶部的状态栏高度
  navStatusBarHeight:
    Platform.OS === 'ios' ? (deviceInfo.isIphoneX ? 44 : 20) : 24,
  // 导航栏除掉状态栏的高度
...
const minStyle = {
  // 夜神
  navHeight: Platform.OS === 'ios' ? (deviceInfo.isIphoneX ? 88 : 64) : 50,
  navIconSize: 20,
  navTitleSize: 16,
  hSize: 20,
  h1Size: 16,
