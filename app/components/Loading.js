...
export default class Loading extends Component {
    ...
    render(){ // 渲染界面
      return(
        <View style={{height:48,minWidth:48,flex:1,backgroundColor:'transparent',transform: [{scale:
          this.props.size&&(this.props.size=="small"?0.8:1.2)||0.8}]}}>
        <Animated.Text 
            style={{
                textAlign: 'center',
                fontSize: 50,
        ...
        return(
            <View style={{height:48,minWidth:48,flex:1,backgroundColor:'transparent',transform: [{scale:
              this.props.size&&(this.props.size=="small"?0.6:1.2)||0.8}]}}>
            <Animated.Text 
                style={{
                    textAlign: 'center',
                    fontSize: 34,
