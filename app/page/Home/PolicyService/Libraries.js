      ...
      <ScrollView style={styles.container}>
        <View style={styles.top}>
           ...
           <View style={styles.rowItem}>
            ...
            <Button style={sortType===1?[styles.button_type,styles.button_type_active]:styles.button_type} 
            textStyle={sortType===1?[styles.button_text,styles.button_text_active]:styles.button_text} onPress={()=>this.handleSortType(1)} >
              按相关度
            </Button>
            <Button style={sortType===2?[styles.button_type,styles.button_type_active]:styles.button_type}
            textStyle={sortType===2?[styles.button_text,styles.button_text_active]:styles.button_text} onPress={()=>this.handleSortType(2)} >
            按时间
            </Button>
           </View>

           <Button style={styles.button_submit} textStyle={styles.submit_text} onPress={this.handleSubmit} >
              搜索
          </Button>
        </View>
