...
class ProjectService extends Component {
  goToDetail=(index)=>{
      switch(index){
        case 1:
        this.props.dispatch(NavigationActions.navigate({routeName:'OnlineInvest'}))
        break;
        case 2:
        this.props.dispatch(NavigationActions.navigate({routeName:'ProjectReport'}))
        break;
        case 3:
        this.props.dispatch(NavigationActions.navigate({routeName:'ProjectCoordinateForm'}))
        break;
        default:
        break;
      }
