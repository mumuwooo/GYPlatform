...
class TechService extends Component {
  gotoDetail=(index)=>{
    switch(index){
      case 1:
      this.props.dispatch(NavigationActions.navigate({routeName:'PatentReport'}))
      break;
      case 2:
      this.props.dispatch(NavigationActions.navigate({routeName:'TechProject'}))
      break;
      case 3:
      this.props.dispatch(NavigationActions.navigate({routeName:'TechAchive'}))
      break;
      default:
      break;
  }
