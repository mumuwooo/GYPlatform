...
class Home extends NavigationPage {
  ...
  renderNavigationBar() {
    return (
      <NavigationBar
        style={{ width, backgroundColor: commonStyle.themeColor }}
        title={
          <Image
            source={require('../../assets/images/logo.png')}
            style={{ width: 180, height: 30, marginBottom: 10 }}
            resizeMode="contain"
          />
        }
      />
    ...
    return (
      <View style={styles.container}>
        <ScrollView style={{ flex: 1 }}>
          ...
          <View style={styles.bannerBox}>{this.renderBanner(slides)}</View>
            ...
            <View style={styles.content_block}>
              ...
              <View style={styles.item_row}>
                <Touchable
                  ...
                  onPress={() => this.handleSubmenuShow(1)}
                >
                ...
                <Touchable
                  style={styles.item_button}
                  onPress={() => this.handleSubmenuShow(2)}
                >
                ...
                <Touchable
                  style={styles.item_button}
                  onPress={() => this.handleSubmenuShow(3)}
                >
              ...
              {companyShow ? (
                <View style={styles.visiable_block}>
                  <CompanyService />
                </View>
              ) : null}
              {projectShow ? (
              ...
              <View style={styles.item_row}>
                <Touchable
                  style={styles.item_button}
                  onPress={() => this.handleSubmenuShow(4)}
                >
                ...
                <Touchable
                  style={styles.item_button}
                  onPress={() => this.handleSubmenuShow(5)}
                >
                ...
                <Touchable
                  style={styles.item_button}
                  onPress={() => this.handleSubmenuShow(6)}
                >
            ...
            <View style={[styles.content_block, styles.content_block2]}>
              <View style={styles.block_title2}>
                ...
                <View style={styles.title_right}>
                  <Text style={[styles.title_text, styles.title_text2]}>
                    更多{' '}
                  </Text>
                  <Text
                    style={[styles.title_text, styles.title_text2]}
                  >{`>`}</Text>
                </View>
              </View>
              <AchiveInfos />
