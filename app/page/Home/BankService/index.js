...
class BankService extends Component {
  goToDetail=(index)=>{
    switch(index){
      case 1:
      this.props.dispatch(NavigationActions.navigate({routeName:'FinanceDemandForm'}))
      break;
      case 2:
      this.props.dispatch(NavigationActions.navigate({routeName:'FinanceGuaranteeForm'}))
      break;
      case 3:
      this.props.dispatch(NavigationActions.navigate({routeName:'BankConnect'}))
      break;
      default:
      break;
    }
