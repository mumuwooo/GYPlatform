    ...
    <View style={[styles.container,style]}>
        <Carousel
            ...
            control={
                ...
                dot={<Text style={styles.item_dot}/>}
                activeDot={<Text style={styles.item_activeDot}/>}
                />}
      >
            {data.map((item,index)=>(
            ...
            <View style={[styles.item_top,styles.item_bottom]} key={index}>
            <Image style={{width: 123, height: 83}} resizeMode='contain' source={require('../../../assets/images/companginfos2.png')} />
            <View style={styles.item_text}>
                <Text style={styles.text_title}>{item.Title}</Text>
                <Text style={styles.text_content} numberOfLines={3}>{item.content}</Text>
            </View>
