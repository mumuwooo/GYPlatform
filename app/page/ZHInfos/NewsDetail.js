...
class NewsDetail extends NavigationPage {
  ...
  renderPage() {
    // const { newList } = this.props.notification
    // const { index } = this.props.navigation.state.params
    // let htmlContent = null
    // if (newList.length > index) {
    //   htmlContent =
    //     newList[index].IsWithout > 0
    //       ? `<a href='${newList[index].Contents}'>${
    //           newList[index].Contents
    //         }</a>`
    //       : htmlDecodeByRegExp(newList[index].Contents)
    // } else {
    //   return
    // }
    // const htmlContent =`
        ...
        <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
            <View style={styles.top}>
                ...
                <View style={styles.top_bottom}>
                    <Text style={styles.bottom_text}>发布时间：2018-11-16 </Text>
